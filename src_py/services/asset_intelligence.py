...
class AssetFinancialIntelligenceService:
    ...
    def simulate_decision_path(
        ...
        if decision == AssetDecisionType.KEEP:
            ...
            # Extend tenure by 50%, reducing monthly EMI by ~35%
            ...
            # Refinance at 2.5% lower rate with small tenure tweak -> 18% EMI reduction
            ...
            # Estimate market salvage value (depreciated based on age vs life)
            ...
            new_op = base_op * 0.55  # 45% power/labor savings
            ...
            title = "6. B2B Capacity Subleasing & Incremental Order Channel"
            # Target 80% utilization with high-margin corporate job-work:
            # Baseline revenue per unit utilization is augmented by 25% premium on guaranteed B2B off-take
            scaling = 80.0 / max(10.0, asset.utilization_percentage)
            new_rev = base_rev * scaling * 1.20
            # Incremental operating cost increases only on variable power & raw materials (35% elasticity)
